...
<div id="primary">
	...
	<form id="item-edit" action="<?php echo API_URL . "item/$id/save"; ?>" method="post" accept-charset="utf-8">
		<ul>
		...
		<p><button type="submit">Save Changes</button> or <a href="<?php echo API_URL . "projects"; ?>">Cancel and go back</a>.</p>
	</form>
</div>