		...
		<div class="project-container">
			<div class="project-header">
				...
				<p class="project-options">
					<a class="edit" href="<?php echo API_URL . "project/$pid/edit.html" ?>">Edit</a>
					<a class="delete" href="<?php echo API_URL . "project/$pid/delete.html" ?>">Delete</a>
				</p>
			</div>
		<?php if( $pid > 0 ) { ?>
		<?php } ?>
...
?>
				<li class="item" id="item-<?php echo $item["id"]; ?>">
					<div class="thumbnail" style="background-image: url(<?php echo IMAGE_URL."image".$item["id"]."_small.jpg"; ?>)"></div>
					<div class="item-details">
						<h3><?php echo $item["title"] . "(" . $item["order"] . ")"; ?></h3>
						<?php if( !empty($item["desc"]) ){ echo "<p class='desc'>".$item["desc"]."</p>"; } ?>
						<p class="item-options">
							<a class="edit" href="<?php echo API_URL ."item/". $item["id"] ."/edit.html" ?>">Edit</a>
							<a class="delete" href="<?php echo API_URL ."item/". $item["id"] ."/delete.html"; ?>">Delete</a>
						</p>
					</div>
				</li>
<?php }
